#orignal file https://github.com/keflavich/brick-jwst-2221/blob/main/brick2221/analysis/merge_catalogs.py
import numpy as np
import time
import datetime
import os
...
filternames = filternames_narrow = ['f410m', 'f405n', 'f187n', 'f182m']
all_filternames = ['f480m', 'f410m', 'f405n', 'f360m', 'f335m', 'f210m', 'f187n', 'f182m', 'f162m', 'f150w', 'f140m']
filternames = all_filternames
...
def merge_crowdsource(module='nrca', suffix="", desat=False, bgsub=False,
    ...
    print(f'basepath: {basepath}', flush=True)
    ...
    for catfn in catfns:
        print(catfn, getmtime(catfn), flush=True)
...
def flag_near_saturated(cat, filtername, radius=None, target='brick',
    ...
    print(filter_to_project, filtername, project_obsnum[target],flush=True)

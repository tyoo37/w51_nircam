...
sbatch --job-name=seshat --output=seshat_%j-%A_%a.log  --account=astronomy-dept --qos=astronomy-dept-b --ntasks=2 --nodes=1 --mem=${mem} --time=96:00:00 --wrap "python /blue/adamginsburg/t.yoo/w51_nircam/analysis/classfication/seshat.py"

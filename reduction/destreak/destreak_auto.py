...
if __name__ == "__main__":
    ...
    parser.add_option("-f", "--filternames", dest="filternames",
                    default='F140M,F150W,F162M,F182M,F187N,F210M,F335M,F360M,F405N,F410M,F480M',
    ...
    for filt in filternames:
        ...
        for file in files:
            if not os.path.isdir(f'{basepath}/{filt}/no_destreak'):
            ...
            plt.show()
            plt.savefig(f'/home/t.yoo/w51/w51_nircam/reduction/destreak/{file.split("/")[-1].replace("_cal.fits", "_destreak_1m1overf.png")}')
            plt.close()

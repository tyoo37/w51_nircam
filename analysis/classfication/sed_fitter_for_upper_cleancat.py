    ...
    if True:
        ...
        if num<10:
            plot_fit_models('W51-E', fits_dict, geom_dict, model_ids_dict, class_dict, stage_dict, spicyid=idx,
                    extinction=extinction,
                loc_imagedir='/orange/adamginsburg/w51/TaehwaYoo/jwst_w51/sed_fitting/plots/uppers/', robitaille_modeldir='/blue/adamginsburg/richardson.t/research/flux/r+24_models-1.2',)
        num+=1


with open(f"/orange/adamginsburg/w51/TaehwaYoo/jwst_w51/sed_fitting/model_dict_upper_{os.getenv('SLURM_ARRAY_TASK_ID')}.pkl", "wb") as f:

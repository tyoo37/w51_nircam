...
imgsavedir = '/orange/adamginsburg/w51/TaehwaYoo/jwst_w51/plots/ccd_branches/cmds/'
filters = {
    'f140m': f140m_mag,
    'f162m': f162m_mag,
    'f182m': f182m_mag,
...
for i, color_pair in enumerate(color_pairs):
    ...
    for mag_filter in filter_names:
        ...
        ax.scatter(color, magnitude, s=10, c='gray', alpha=0.5, edgecolor='none')
        ax.scatter(color[idx1], magnitude[idx1], s=10, c='orange', marker='^',alpha=0.5, edgecolor='none', label='upper branch')
        ax.scatter(color[idx2], magnitude[idx2], s=10, c='blue', marker='s', alpha=0.5, edgecolor='none', label='lower branch')
